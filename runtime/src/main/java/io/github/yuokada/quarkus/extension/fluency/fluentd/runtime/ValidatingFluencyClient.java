...
/**
 * A validating wrapper around {@link FluencyClient} that enforces tag and data constraints before
 * delegating to the underlying client.
 *
 * <p>Throws {@link IllegalArgumentException} on invalid input rather than silently failing or
 * propagating internal library errors.
 */
@ApplicationScoped
